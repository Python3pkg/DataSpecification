...
latex_documents = [
  ('index', 'DataSpecification.tex', 'DataSpecification Documentation',
   '', 'manual'),
]
...
man_pages = [
    ('index', 'DataSpecification', 'DataSpecification Documentation',
     [''], 1)
]
...
epub_title = 'DataSpecification'
epub_author = ''
epub_publisher = ''
epub_copyright = '2014-2017'
